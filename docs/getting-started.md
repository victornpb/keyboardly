...
To enable those navigations, we must add some configurations to the site. Head to  to learn how to configure VitePress.
...
If you want to know how to customize how the site looks (Theme), and find out the features VitePress's default theme provides, visit 
